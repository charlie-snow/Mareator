...
const Tiempo = (props) => {
  ...
  let horas_hoy = fecha_actual.getHours();
  // horas_hoy = (horas_hoy === 0) ? 23 : horas_hoy;
        ...
        <>
          <table className="tabla_barrainfo">
            <tr>
              ...
              <td width="18%">
                <span style={estilo_1linea}>{temperatura}</span>  <span style={{ ...estilo_1linea_peq, verticalAlign: 'top' }}>{"º"}</span>
              </td>
              <td width="9%">
                <div className="rotated-text">
                  Cielo
              ...
              <td style={{ verticalAlign: "middle" }} width="15%">
                <img src="imagenes/sol.png" ref={img_cielo} height={40} width={40} />
              </td>
              <td width="9%">
                <div className="rotated-text">
                  Lluvia
              ...
              <td width="15%">
                <img src="imagenes/seco.png" ref={img_lluvia} height={30} width={30} />
              </td>
            </tr>
          </table>
        </>
  ...
  return (
    <div>
      ...
      <div className="card m-2" style={{ width: "100%", height: "175px" }}>
        ...
        <canvas ref={grafica} style={{ width: "100%" }}></canvas>
      </div>
    </div>
  );
};
